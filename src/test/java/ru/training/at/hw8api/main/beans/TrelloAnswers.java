...
public class TrelloAnswers {
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((
            ...
            (this.id != null) && this.id.equals(rhs.id)))) && ((this.limits == rhs.limits) || ((this.limits != null)
            && this.limits.equals(rhs.limits)))) && ((this.powerUps == rhs.powerUps) || ((this.powerUps != null)
            && this.powerUps.equals(rhs.powerUps)))) && ((this.templateGallery == rhs.templateGallery) || (
            (this.templateGallery != null) && this.templateGallery.equals(rhs.templateGallery)))) && (
            (this.url == rhs.url) || ((this.url != null) && this.url.equals(rhs.url)))) && ((this.prefs == rhs.prefs)
            || ((this.prefs != null) && this.prefs.equals(rhs.prefs)))) && (
            (this.enterpriseOwned == rhs.enterpriseOwned) || ((this.enterpriseOwned != null) && this.enterpriseOwned
                .equals(rhs.enterpriseOwned)))) && ((this.ixUpdate == rhs.ixUpdate) || ((this.ixUpdate != null)
            && this.ixUpdate.equals(rhs.ixUpdate)))) && ((this.name == rhs.name) || ((this.name != null) && this.name
            .equals(rhs.name)))) && ((this.closed == rhs.closed) || ((this.closed != null) && this.closed
            .equals(rhs.closed)))) && ((this.idMemberCreator == rhs.idMemberCreator) || ((this.idMemberCreator != null)
            && this.idMemberCreator.equals(rhs.idMemberCreator)))) && ((this.desc == rhs.desc) || ((this.desc != null)
