...
public class PerBoard {
    ...
    public String toString() {
        ...
        sb.append(PerBoard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
          .append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerBoard) == false) {
            return false;
        }
        PerBoard rhs = ((PerBoard) other);
        return (
            (((this.disableAt == rhs.disableAt) || ((this.disableAt != null) && this.disableAt.equals(rhs.disableAt)))
                && ((this.warnAt == rhs.warnAt) || ((this.warnAt != null) && this.warnAt.equals(rhs.warnAt)))) && (
